...
const AccountsRoute = (app) => {
    ...
    async (req, res) => {
      try {
        ...
        return apiResponseSuccess(
          ...
          true,
          statusCode.success,
          " Admins with 'Bank-View' role found.",
          res
        );
      } catch (error) {
        console.error(e);
    ...
    async (req, res) => {
      try {
        ...
        return apiResponseSuccess(
          ...
          true,
          statusCode.success,
          " Suceessfully Retrived Admin User Name",
          res
        );
      } catch (error) {
        console.error(error);
  ...
  app.get(
    "/api/intoducer/client-data/:id",customErrorHandler,
    Authorize(["superAdmin", "Profile-View", "Introducer-Profile-View"]),
    async (req, res) => {
      try {
        const id = req.params.id;
        ...
        if (!intoducer) {
          return apiResponseErr(
            ...
            false,
            statusCode.notFound,
            `Introducer not found with ID: ${id}.`,
            res
          );
        }
  ...
  app.get(
    "/api/get-single-Introducer/:id",customErrorHandler,
    Authorize(["superAdmin", "Profile-View", "Introducer-Profile-View"]),
    async (req, res) => {
      try {
        const id = req.params.id;
  ...
  app.post(
    '/api/admin/filter-data',customErrorHandler,
    Authorize([
      'superAdmin',
      'Dashboard-View',
      'Transaction-View',
